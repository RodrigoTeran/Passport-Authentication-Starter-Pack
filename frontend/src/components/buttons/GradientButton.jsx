...
const GradientButton = ({ app }) => {
  const { img, href, alt, txt, name, colors } = app;

  const style = {
    margin: 5,
    display: "block",
    background: `
      radial-gradient(circle farthest-corner at 35% 90%, ${colors.leftBot}, transparent 50%),
  ...
  return (
    <a href={href}
      ...
      style={style}
      title={txt}>
      <img src={img} alt={alt} className="btn-icon"></img>
